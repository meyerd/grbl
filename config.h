...
#define ELCHEAPO_MOTOR_X_DDR	DDRF
#define ELCHEAPO_MOTOR_X_PORT	PORTF
#define ELCHEAPO_MOTOR_X_COILA_FORWARD	4
#define ELCHEAPO_MOTOR_X_COILA_BACKWARD	5
#define ELCHEAPO_MOTOR_X_COILB_FORWARD	6
#define ELCHEAPO_MOTOR_X_COILB_BACKWARD	7
#define ELCHEAPO_MOTOR_X_COIL_MASK ((1<<ELCHEAPO_MOTOR_X_COILA_FORWARD)|(1<<ELCHEAPO_MOTOR_X_COILA_BACKWARD)|(1<<ELCHEAPO_MOTOR_X_COILB_FORWARD)|(1<<ELCHEAPO_MOTOR_X_COILB_BACKWARD))

#define ELCHEAPO_MOTOR_Y_DDR	DDRD
#define ELCHEAPO_MOTOR_Y_PORT	PORTD
#define ELCHEAPO_MOTOR_Y_COILA_FORWARD	0
#define ELCHEAPO_MOTOR_Y_COILA_BACKWARD	1
#define ELCHEAPO_MOTOR_Y_COILB_FORWARD	2
#define ELCHEAPO_MOTOR_Y_COILB_BACKWARD	3
#define ELCHEAPO_MOTOR_Y_COIL_MASK ((1<<ELCHEAPO_MOTOR_Y_COILA_FORWARD)|(1<<ELCHEAPO_MOTOR_Y_COILA_BACKWARD)|(1<<ELCHEAPO_MOTOR_Y_COILB_FORWARD)|(1<<ELCHEAPO_MOTOR_Y_COILB_BACKWARD))
